...
INSERT INTO plant_caring_instruction (instruction_text, plant_group_id, posted_by_id)
  VALUES ('we recommend placing it in a shallow tray filled with a layer of gravel with water added', 1, 1), ('Fertilizing is also necessary if your bonsai is to remain healthy and beautiful', 1, 2), ('You will need to fertilize your apple tree so that it maintains the necessary nutrients', 2, 2), ('Humans aren’t the only ones attracted to apple trees. Many pests are known to be drawn to them as well', 2, 1), ('Apple maggot flies are notorious for laying their eggs on apples in the summer months', 2, 3), ('You can prevent pests by placing red sphere traps on your tree.', 2, 4), ('Plum trees love a full sun, so plan where you want to plant your trees', 6, 1), ('Wait a month after you prepare your soil, and then begin planting your trees', 6, 2), ('The amount and frequency of water your plum trees need depends on the weather', 6, 4), ('Water blueberry plants during the day. Keep the soil moist but not soggy', 8, 1);
...
INSERT INTO plant_order (post_id, customer_id)
  VALUES (1, 5), (2, 8), (3, 9), (4, 6), (5, 7), (6, 7), (7, 7), (8, 6), (9, 5), (10, 9);
